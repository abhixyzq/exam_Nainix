        ...
        questions: [
          {
            ...
            questionEn: "What is the focal length of a plane mirror?",
            questionHi: "समतल दर्पण की फोकस दूरी क्या होती है?",
            options: ["Zero / शून्य", "Infinite / अनंत", "25 cm / 25 सेमी", "-25 cm / -25 सेमी"],
            optionsEn: ["Zero", "Infinite", "25 cm", "-25 cm"],
            optionsHi: ["शून्य", "अनंत", "25 सेमी", "-25 सेमी"],
            correctIndex: 1,
            explanation: "Since the radius of curvature of a plane mirror is infinite, its focal length (f = R/2) is also infinite.",
            explanationEn: "Since the radius of curvature of a plane mirror is infinite, its focal length (f = R/2) is also infinite.",
            explanationHi: "चूँकि समतल दर्पण की वक्रता त्रिज्या अनंत होती है, इसलिए इसकी फोकस दूरी (f = R/2) भी अनंत होती है।",
          ...
          },
          {
            ...
            questionEn: "The speed of light in vacuum is approximately equal to:",
            questionHi: "निर्वात में प्रकाश की चाल लगभग कितनी होती है?",
            options: ["3 × 10^8 m/s", "3 × 10^5 m/s", "3 × 10^8 km/s", "3 × 10^6 m/s"],
            optionsEn: ["3 × 10^8 m/s", "3 × 10^5 m/s", "3 × 10^8 km/s", "3 × 10^6 m/s"],
            optionsHi: ["3 × 10^8 मी/से", "3 × 10^5 मी/से", "3 × 10^8 किमी/से", "3 × 10^6 मी/से"],
            correctIndex: 0,
            explanation: "The speed of light in vacuum or air is 3 × 10^8 meters per second.",
            explanationEn: "The speed of light in vacuum or air is 3 × 10^8 meters per second.",
            explanationHi: "निर्वात या वायु में प्रकाश की चाल 3 × 10^8 मीटर प्रति सेकंड होती है।",
            chapter: "Light Reflection & Refraction",
            isVVI: true
          },
          {
            ...
            questionEn: "An image formed by a concave mirror is real, inverted and of the same size as the object. Where is the object placed?",
            questionHi: "अवतल दर्पण द्वारा बना प्रतिबिंब वास्तविक, उल्टा तथा वस्तु के आकार का बनता है। वस्तु कहाँ स्थित है?",
            options: ["At Focus (F) / फोकस पर", "Between F and C / F तथा C के बीच", "At Centre of Curvature (C) / वक्रता केंद्र पर", "Beyond C / C से परे"],
            optionsEn: ["At Focus (F)", "Between F and C", "At Centre of Curvature (C)", "Beyond C"],
            optionsHi: ["फोकस (F) पर", "F तथा C के बीच", "वक्रता केंद्र (C) पर", "C से परे"],
            correctIndex: 2,
            ...
            explanationEn: "When an object is placed at the Centre of Curvature (C) of a concave mirror, its image is also formed at C, real, inverted and equal in size.",
            explanationHi: "जब वस्तु अवतल दर्पण के वक्रता केंद्र (C) पर रखी जाती है, तो इसका प्रतिबिंब भी C पर वास्तविक, उल्टा और समान आकार का बनता है।",
            chapter: "Light Reflection & Refraction",
            isVVI: true
          },
          {
            ...
            questionEn: "SI unit of power of a lens is:",
            questionHi: "लेंस की क्षमता का SI मात्रक क्या होता है?",
            options: ["Meter / मीटर", "Diopter / डायोप्टर", "Centimeter / सेमी", "Watt / वाट"],
            optionsEn: ["Meter", "Diopter", "Centimeter", "Watt"],
            optionsHi: ["मीटर", "डायोप्टर (Diopter)", "सेमी", "वाट"],
            correctIndex: 1,
            explanation: "Power of a lens P = 1/f (in meters). Its SI unit is Diopter (D).",
            explanationEn: "Power of a lens P = 1/f (in meters). Its SI unit is Diopter (D).",
            explanationHi: "लेंस की क्षमता P = 1/f (मीटर में)। इसका SI मात्रक डायोप्टर (D) होता है।",
            chapter: "Light Reflection & Refraction",
            isVVI: true
          }
        ]
